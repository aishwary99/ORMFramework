...
{
entity=entityManager.loadEntity(object);
...
/*
System.out.println("------------- Printing PS Map -----------------");
...
System.out.println(insertWrapper.getSQLStatement());
System.out.println("--------------------------------------------------------------");
...
System.out.println("Checking for field : "+field.getName());
if(ignoredFields.containsKey(field.getName())) continue;
Method pojoGetterMethod=pojoGetterMethods.get(i).getValue();
System.out.println("\t getter picked out : "+pojoGetterMethod.getName());
...
public void showDataStructures(Map<Class,Method> map1,List<Pair<Field,Method>> map2)
{
for(Pair<Field,Method> p:map2)
{
...
List<Pair<Field,Method>> pojoGetterMethods=insertWrapper.getPOJOGetterMethods();
//showDataStructures(preparedStatementSetterMethods,pojoGetterMethods);
...
System.out.println("\tAuto Incremented Field Value : "+autoIncrementedFieldValue);
...
System.out.println("\t Is Auto Incremented Field : "+isAutoIncrementField);
System.out.println("\t Include in statement : "+includeInStatement);
System.out.println("--------------------------------------------------------------------------");
